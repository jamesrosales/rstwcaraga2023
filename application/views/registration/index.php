...
img.mobile-tribal, img.show_img{
        ...
        .select2-container--default.select2-container--focus .select2-selection--multiple{
            ...
            border-bottom: 2px solid #e89822 !important;
        }
    ...
    <div class="container" style="box-shadow: 0 3px 6px #8d4b0b; border-radius: 20px;">
        ...
        <div class="row">
            ...
            <div class="col-sm-5" style="padding: 0px;">
                <img src="<?php echo base_url('assets/img/Website Front.jpg'); ?>" style="height: 650px;border-top-left-radius: 20px;border-bottom-left-radius: 20px;" class="right">
            ...
            <div class="col-sm-6 Left">
                <div class="row">
                    <div class="col-sm-12">
                        <div class="row">
                            <div class="col-sm-8">
                                <h3 style="color:#fa920f;">Registration</h3>
                                <hr>
                            </div>
                            <div class="col-sm-4">
                                <h6>Note:</h6>
                                <p style="font-size:12px">Ignore this if you're already registered.</p>
                ...
                <div class="col-sm-12">
                    <div class="row">
                        ...
                        <div class="col-sm-12 " style="text-align: justify;">
                            ...
                            Best regards,<br>
                            16th PNHRS Registration Committee
                ...
                <form id="Register">
                <div class="col-sm-12">
                    <p style="font-size:12px">Fill in the necessary information.</p>
                    <div class="form-row">
            ...
            <div class="col-sm-12">
                <div class="row">
                    ...
                    <div class="form-group col-sm-4">
                        <input type="text" class="form-control input_textarea" name="usr_contact" required placeholder="Mobile Number" >
                    </div>
                </div>
            </div>
            <div class="col-sm-12">
                <div class="row">
                    <div class="form-group col-sm-6">
                        <input type="text" class="form-control input_textarea" name="usr_occupation" required placeholder="Occupation/Position" >
                    </div>
                    <div class="form-group col-sm-6">
                        <input type="text" class="form-control input_textarea" name="usr_institution" required placeholder="Name of Firm/Institution" >
                    </div>
                </div>
            </div>
            <div class="col-sm-12">
            ...
            <div class="col-sm-12">
                <div class="row">
                    ...
                    <div class="col-sm-8">
                        <br>
                        <input type="submit" name="signup" class="btn btn-block btn-orange" value="Register">
                        <center>
                            <a href="<?php echo base_url('Registration/SignIn'); ?>" class="btn btn-sm" style="margin-top:0px;">Login</a>
                        </center>
                    </div>
                    <div class="col-sm-2">
            ...
            <div class="col-sm-1" style="background-color: #fff; border-top-right-radius: 20px;border-bottom-right-radius: 20px;">
                ...
                <img src="<?php echo base_url('assets/img/Tribal 3.png'); ?>" style="height: 65px;margin-left: -50px;margin-top: 27px; border-bottom-right-radius: 20px;" class="mobile-tribal">

                <img src="<?php echo base_url('assets/img/Tribal.png'); ?>" style="height: 650px;margin-left: 19px;border-top-right-radius: 20px;border-bottom-right-radius: 20px;" class="mobile-down">
            </div>
